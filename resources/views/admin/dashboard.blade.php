...
@section('title', 'Dashboard - HIMATIF UCIC')
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-primary mini-stat text-white">
                        <div class="p-3 mini-stat-desc">
                            ...
                            <div>
                                <span class="badge badge-light text-info"> +11% </span> <span class="ml-2">From
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-success mini-stat text-white">
                        <div class="p-3 mini-stat-desc">
                            ...
                            <div>
                                <span class="badge badge-light text-info"> +89% </span> <span class="ml-2">From
                                    previous period</span>
                            </div>
                        </div>
                        <div class="p-3">
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted mb-4">At vero eos et accusamus et iusto odio
                                                dignissimos ducimus qui blanditiis atque quos dolores et</p>
